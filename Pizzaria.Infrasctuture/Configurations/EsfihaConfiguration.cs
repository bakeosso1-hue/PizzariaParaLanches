...
{
    public class EsfihaConfiguration : IEntityTypeConfiguration<Esfiha>
    {
        public void Configure(EntityTypeBuilder<Esfiha> builder)
        {
            ...
            builder.HasOne(g => g.Category)       // Um Game tem UMA Category
                .WithMany(c => c.Esfihas)            // Uma Category tem MUITOS Games
